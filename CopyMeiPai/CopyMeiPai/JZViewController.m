...
@interface JZViewController()<ThemeScrollViewDelegate, PBJVideoPlayerControllerDelegate, CMPopTipViewDelegate>
{
    NSURL* _videoPickURL;
...
#pragma mark - private Method 读取相册中的视频
